    ...
    <section class="food-menu"  style="background-image: url('images/foodmenu2.jpg');">
        <div class="container">
            ...
            <?php
                ...
                //Getting food from Db that are active and features
                //SQl Query
                $sql2 = "SELECT * FROM tbl_food WHERE active='Yes' AND featured='Yes' LIMIT 32";
                ...
                if($count2>0)
                {
                    ...
                    {
                         //food not Available
                        echo "<div class='eror'>Food not Added.</div>";
                    }
